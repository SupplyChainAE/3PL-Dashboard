...
<!-- 			class="label label-primary pull-right">4</span> </a> -->
<!-- 		<ul class="treeview-menu"> -->
<!-- 			<li><a href="pages/layout/top-nav.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Top Navigation</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/layout/boxed.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Boxed</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/layout/fixed.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Fixed</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/layout/collapsed-sidebar.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Collapsed Sidebar</a> -->
<!-- 			</li> -->
<!-- 		</ul></li> -->
...
<!-- 			<span>Charts</span> <i class="fa fa-angle-left pull-right"></i> </a> -->
<!-- 		<ul class="treeview-menu"> -->
<!-- 			<li><a href="pages/charts/chartjs.html"><i -->
<!-- 					class="fa fa-circle-o"></i> ChartJS</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/charts/morris.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Morris</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/charts/flot.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Flot</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/charts/inline.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Inline charts</a> -->
<!-- 			</li> -->
<!-- 		</ul></li> -->
...
<!-- 					class="fa fa-circle-o"></i> General Elements</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/forms/advanced.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Advanced Elements</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/forms/editors.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Editors</a> -->
<!-- 			</li> -->
<!-- 		</ul></li> -->
<!-- 	<li class="treeview"><a href="#"> <i class="fa fa-table"></i> -->
<!-- 			<span>Tables</span> <i class="fa fa-angle-left pull-right"></i> </a> -->
<!-- 		<ul class="treeview-menu"> -->
<!-- 			<li><a href="pages/tables/simple.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Simple tables</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/tables/data.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Data tables</a> -->
<!-- 			</li> -->
<!-- 		</ul></li> -->
...
<!-- 			class="label pull-right bg-yellow">12</small> </a></li> -->
<!-- 	<li class="treeview"><a href="#"> <i class="fa fa-folder"></i> -->
<!-- 			<span>Examples</span> <i class="fa fa-angle-left pull-right"></i> </a> -->
<!-- 		<ul class="treeview-menu"> -->
<!-- 			<li><a href="pages/examples/invoice.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Invoice</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/examples/login.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Login</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/examples/register.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Register</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/examples/lockscreen.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Lockscreen</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/examples/404.html"><i -->
<!-- 					class="fa fa-circle-o"></i> 404 Error</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/examples/500.html"><i -->
<!-- 					class="fa fa-circle-o"></i> 500 Error</a> -->
<!-- 			</li> -->
<!-- 			<li><a href="pages/examples/blank.html"><i -->
<!-- 					class="fa fa-circle-o"></i> Blank Page</a> -->
<!-- 			</li> -->
<!-- 		</ul></li> -->
